...
export function Footer() {
  return (
    <footer className="border-t border-emerald-500/10 bg-black/40 backdrop-blur-sm mt-16 pb-[env(safe-area-inset-bottom,0px)]">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="font-bold text-white text-sm">am<span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-300 to-cyan-300">Employer</span></span>
